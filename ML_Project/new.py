...
good_dir = "storage/app/ML_Project/good/"
bad_dir = "storage/app/ML_Project/bad/"
...
default_dir_path = 'storage/app/ML_Project/images/'
...
def sort_blurry(dir_path):
    ...
    for file in os.listdir(dir_path):
        ...
        blur, blinks = get_cull_image(file_path)

        if blur < 0.5 and blinks[0] == 0:
